...
class OICResponseHandlerTest extends TestCase
{
    ...
    public function codeerrorDataProvider()
    {
        return array(
            ...
            array('content' => 'unsupported_grant_type', 'exception' => 'Syntelix\Bundle\OidcRelyingPartyBundle\Security\Core\Exception\UnsupportedGrantTypeException'),
        );
    }
